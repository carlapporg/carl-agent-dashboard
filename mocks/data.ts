...
export let mockTasks: Task[] = [
  ...
  },
  {
    ...
    aiBrief: {
      summary: "Prescription pickup and home drop-off.",
  ...
  },
  {
    id: "task_4801",
    number: 4801,
    title: "Airport lounge booking",
    request: "Reserve Priority Pass lounge access for tomorrow morning.",
    status: "completed",
    priority: "normal",
    customerId: "cust_sara",
    customerName: "Sara Chen",
    ...
    assignedAgentId: "agent_stub_001",
    aiBrief: {
      summary: "Lounge access confirmed for Sara Chen.",
      missingInfo: [],
      suggestedActions: ["Confirm flight", "Book lounge", "Send confirmation"],
    },
    notes: [],
    suggestedStepsDone: [
      "Confirm flight",
