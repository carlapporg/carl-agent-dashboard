    ...
    <>
      <div>
        <button
          ...
          className={cn(
            "inline-flex h-[35px] items-center gap-2.5 rounded-[40px] py-0 pl-4 pr-2 text-[12px] font-medium tracking-[-0.05em] text-foreground",
            isAvailable
        ...
        >
          ...
          <span
            ...
            aria-hidden
          />
          <span className="flex size-[29px] items-center justify-center rounded-full bg-surface-hover text-foreground">
            <ChevronIcon
              direction="right"
              className={cn(
          ...
          {OPTIONS.map((option) => {
            ...
            return (
              <button
                ...
                className={dropdownItemClass({ selected })}
              >
                <span
                  className={cn(
